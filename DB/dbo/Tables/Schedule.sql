...
GO
ALTER TABLE [dbo].[Schedule] ADD  CONSTRAINT [FK_Schedule_Child] FOREIGN KEY([ChildId])
REFERENCES [dbo].[Child] ([ID])
GO

ALTER TABLE [dbo].[Schedule] CHECK CONSTRAINT [FK_Schedule_Child]
GO
ALTER TABLE [dbo].[Schedule] ADD  CONSTRAINT [FK_Schedule_Dose] FOREIGN KEY([DoseId])
